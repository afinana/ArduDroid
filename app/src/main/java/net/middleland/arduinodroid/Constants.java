...
package net.middleland.arduinodroid;

/**
 * Defines several constants used between {@link BluetoothArduinoService} and the UI.
 */
public interface Constants {
    ...
    public static final int BT_SEARCHING = 2;
    public static final int BT_UNCONNECTED = 3;

package net.middleland.arduinodroid.views;
...
import net.middleland.arduinodroid.common.Utils;

/**
 * Created by Antonio on 10/02/2018.
 */
...
public class Thermometer extends View {
    ...
    public void init(Context context, AttributeSet attrs) {
        utils = new Utils(context.getResources());
